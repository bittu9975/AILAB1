...
int isValid(node* nodeList, const int count, string s1, string s2, string s3) {
        ...
        for (i = s1.length() - 1; i >= 0; i--) { // find number for the first string
                char ch = s1[i];
                for (j = 0; j < count; j++)
        ...
        m = 1;
        for (i = s2.length() - 1; i >= 0; i--) { // find number for the second string
                char ch = s2[i];
                for (j = 0; j < count; j++)
        ...
        m = 1;
        for (i = s3.length() - 1; i >= 0; i--) { // find number for the third string
                char ch = s3[i];
                for (j = 0; j < count; j++)
                        if (nodeList[j].letter == ch)
                                break;
